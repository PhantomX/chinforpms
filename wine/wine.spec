...
%global wine_stagingver 80498dd4408b93dd4591d46928b5ec7f8aca6144
...
%global tkg_id 891fc2b84cc7a7c27141c318c9971fdf656d173c
...
Patch7643:      %{whq_url}/1dd3051cca5cafe90ce44460731df61abb680b3b#/%{name}-whq-1dd3051.patch
Patch7644:      %{whq_url}/feb5229091df97a66c41faad04160d0741ae299d#/%{name}-whq-feb5229.patch
Patch7645:      %{whq_url}/468af5bbb47b70630c2ecfefedce581558287ecf#/%{name}-whq-468af5b.patch
Patch7646:      %{whq_url}/3cd3b775224a9b58cd803348402aa757660ae856#/%{name}-whq-3cd3b77.patch
Patch7647:      %{whq_url}/0dd6f1ef35efa811989716b3dbe52b988bf34ad4#/%{name}-whq-0dd6f1e.patch
Patch7648:      %{whq_url}/4d33a0410e40879ca405a1870cc53ff4da2cc7ba#/%{name}-whq-4d33a04.patch
Patch7649:      %{whq_url}/01d203eebf60a4f07be658e6a66d50909c90cf75#/%{name}-whq-01d203e.patch
Patch7650:      %{whq_url}/73f55e234101739a456774a334e1d732b57afd0b#/%{name}-whq-73f55e2.patch
Patch7651:      %{whq_url}/0cdb070b76fc90b61fe435594e524fb8f9123fff#/%{name}-whq-0cdb070.patch
Patch7652:      %{whq_url}/666c5b6e20e3b9e1e34d10b88372406f494699f2#/%{name}-whq-666c5b6.patch
Patch7653:      %{whq_url}/af0ae9df1e704c054e4c7fdb2f5a4e2a4f2d55e8#/%{name}-whq-af0ae9d.patch
Patch7654:      %{whq_url}/2fd27f0a04a54136acc0cf138e1a6a6b7a47a1e0#/%{name}-whq-2fd27f0.patch
Patch7655:      %{whq_url}/6f5872cbc58d5a6e26f651baa27412b010943de7#/%{name}-whq-6f5872c.patch
...
Patch7667:      %{whq_url}/c73ae99ff49944e3f544dd901628538984f85c4c#/%{name}-whq-c73ae99.patch
Patch7668:      %{whq_url}/c670df976c10e29e095dc0b0113669800b0dd0cb#/%{name}-whq-c670df9.patch
Patch7669:      %{whq_url}/2eed0cdb8f860d37f4efa631719a0a9ae4f721e1#/%{name}-whq-2eed0cd.patch
Patch7670:      %{whq_url}/123a4a884f343f76d40b843740c3c4290d5eca71#/%{name}-whq-123a4a8.patch
Patch7671:      %{whq_url}/b67bbb732be82dedee93c88cf92c92c0540f3514#/%{name}-whq-b67bbb7.patch
Patch7672:      %{whq_url}/3541deb0c3a64d3474a96728d259907180fd7cf6#/%{name}-whq-3541deb.patch
Patch7673:      %{whq_url}/a014f413d6719cce883cafe9f40ec0b6468de097#/%{name}-whq-a014f41.patch
Patch7674:      %{whq_url}/9cc92365560f19c2fd2b9796f79aa75e02381bb1#/%{name}-whq-9cc9236.patch
Patch7675:      %{whq_url}/148d3aa461126ab6e77e36e33493f87d539cd6ec#/%{name}-whq-148d3aa.patch
Patch7676:      %{whq_url}/5ad25c293b6a7b5cd5dea43f29f6fa94d8302722#/%{name}-whq-5ad25c2.patch
Patch7677:      %{whq_url}/6456973f0a64d326bb54da4675310caffc2588f1#/%{name}-whq-6456973.patch
Patch7678:      %{whq_url}/a9722145a86ce3392630d469308a9dd731e62e79#/%{name}-whq-a972214.patch
Patch7679:      %{whq_url}/cdfec11e42e59c497e9b1760f73b68283d568225#/%{name}-whq-cdfec11.patch
Patch7680:      %{whq_url}/c21a7500aecd3920db516efaecc051e2b34196dc#/%{name}-whq-c21a750.patch
Patch7681:      %{whq_url}/da3bd4cb4a1c9644717547e0453ccd3498a3ceb9#/%{name}-whq-da3bd4c.patch
Patch7682:      %{whq_url}/a33594a0483be2fe30d6cff8e523a9bb208b7240#/%{name}-whq-a33594a.patch
Patch7683:      %{whq_url}/c6909e52543b62dfcd5b183014e6eae27b69f3fc#/%{name}-whq-c6909e5.patch
Patch7684:      %{whq_url}/ef5af87f6cc951b29800bcaf97bc1d9c86283b4a#/%{name}-whq-ef5af87.patch
Patch7685:      %{whq_url}/aecf53d0f745a65c15e0f1abbaf27af0d7c0a486#/%{name}-whq-aecf53d.patch
Patch7686:      %{whq_url}/fc408f3d4376722dbe173495be10ef2ce34874d1#/%{name}-whq-fc408f3.patch
Patch7687:      %{whq_url}/158471d676e799d3d23a356b442ecc4afd2ade57#/%{name}-whq-158471d.patch
Patch7688:      %{whq_url}/52f6a56a1aa450c893e19a0e63a90c60626d3dcf#/%{name}-whq-52f6a56.patch
Patch7689:      %{whq_url}/c47f64bd3e5ca6e10096dc9b39d3df2cc9be95a0#/%{name}-whq-c47f64b.patch
Patch7690:      %{whq_url}/ef57a8df8b53fcacf769a28bb9f4e77317ce7167#/%{name}-whq-ef57a8d.patch
Patch7691:      %{whq_url}/6bcc1b9225efe028319bbc64ce6b42a03e4d7ec7#/%{name}-whq-6bcc1b9.patch
Patch7692:      %{whq_url}/0957f9302ca40bd85e092ed335d3fd10ab9bf4da#/%{name}-whq-0957f93.patch
Patch7693:      %{whq_url}/54e117018cd4cc58c258da92686bfad13946bde2#/%{name}-whq-54e1170.patch
Patch7694:      %{whq_url}/43f822bca27b983e6ecca11f4204348a38ba7147#/%{name}-whq-43f822b.patch
Patch7695:      %{whq_url}/4eb3ab95c75eb4eb33c01d22affdfd303590d87a#/%{name}-whq-4eb3ab9.patch
Patch7696:      %{whq_url}/d8f7d5457355cd226f0490d849dcd7a34d5f82f0#/%{name}-whq-d8f7d54.patch
Patch7697:      %{whq_url}/9c8dce215512ac42ed657ce0dd6681712a4c29c3#/%{name}-whq-9c8dce2.patch
Patch7698:      %{whq_url}/60a8f050a5b438ea06898f09d081206977ebde9a#/%{name}-whq-60a8f05.patch
Patch7699:      %{whq_url}/ba2924a64dee3d672230bc7bf7a60ec6b67c8ab9#/%{name}-whq-ba2924a.patch
Patch7700:      %{whq_url}/3ad1739bc85a69c3a2ee4df2ccc1d7b60b466e9c#/%{name}-whq-3ad1739.patch
Patch7701:      %{whq_url}/db8a75312d55480392a8bd9304339b5adba70de4#/%{name}-whq-db8a753.patch
Patch7702:      %{whq_url}/29334489795f0f3fbca52b65b7c5a002983a997b#/%{name}-whq-2933448.patch
Patch7703:      %{whq_url}/18df4912f455e0fb09b232a409c5825a44ee8f2c#/%{name}-whq-18df491.patch
Patch7704:      %{whq_url}/1c84ac61e6674e2951691d97f27d75f667b00c97#/%{name}-whq-1c84ac6.patch
Patch7705:      %{whq_url}/bce9cdcc9812a1a22bd744c64309ba83b4eb4e89#/%{name}-whq-bce9cdc.patch
Patch7706:      %{whq_url}/16832064254bb4a72f6895ee159d68c36f5a972c#/%{name}-whq-1683206.patch
Patch7707:      %{whq_url}/c58a10c16395c30e7793cde1f748febe0432a6ad#/%{name}-whq-c58a10c.patch
Patch7708:      %{whq_url}/2e51f9aae37777762321f1e813a7e9c6050e02e2#/%{name}-whq-2e51f9a.patch
Patch7709:      %{whq_url}/5e9b1a3c6752e953baeaa10c13f1ef887ddfb471#/%{name}-whq-5e9b1a3.patch
Patch7710:      %{whq_url}/7b79c8059dc61686fa3a9dfecdd9ebb34791b233#/%{name}-whq-7b79c80.patch
Patch7711:      %{whq_url}/bdb2fe0cad3b34bb6c5b70926cc848f0b9e9e60f#/%{name}-whq-bdb2fe0.patch
Patch7712:      %{whq_url}/96dcee64307b63ed3c07d13832fee15c3dc21ff1#/%{name}-whq-96dcee6.patch
Patch7713:      %{whq_url}/c840de2839f67793483bae633362b2daf00e3949#/%{name}-whq-c840de2.patch
Patch7714:      %{whq_murl}/commit/05628e169db4c8aa4ad36953d07b13d71ff3a5e0.patch#/%{name}-whq-05628e1.patch
Patch7715:      %{whq_url}/26c715f85b490eda36fa06473a24218bda40a56e#/%{name}-whq-26c715f.patch
Patch7716:      %{whq_url}/79cb33e192be9b41d9d077564b0197b53c1a228c#/%{name}-whq-79cb33e.patch
Patch7717:      %{whq_url}/cd9f96c7ce868514c481b02412ca2db157022f61#/%{name}-whq-cd9f96c.patch
Patch7718:      %{whq_url}/810873eb7561e147dff871aa20315e930d1f01bb#/%{name}-whq-810873e.patch
Patch7719:      %{whq_url}/e8e1f1e634634a05aaed8e5d0fad9d72da499e02#/%{name}-whq-e8e1f1e.patch
Patch7720:      %{whq_url}/d6c4efec1ab726b70a660b8a3195eb43003793b5#/%{name}-whq-d6c4efe.patch
Patch7721:      %{whq_url}/5c4d6cf8375b69f15df4e79b23a8c95c634b7421#/%{name}-whq-5c4d6cf.patch
Patch7722:      %{whq_url}/82c84548ebee6f2577f65e0a5df21fef898b6990#/%{name}-whq-82c8454.patch
Patch7723:      %{whq_url}/25692223f1cf1f451e4283a2d07a89d1dd7cd3eb#/%{name}-whq-2569222.patch
Patch7724:      %{whq_url}/3b3c8619c852513f57ce7388557c8451691fbe00#/%{name}-whq-3b3c861.patch
Patch7725:      %{whq_url}/d22e82196496cb6d7f26b984b95409678a76c602#/%{name}-whq-d22e821.patch
Patch7726:      %{whq_url}/b9f1ec8c44ebe62b4005d4ea2cfd63f700ea8a17#/%{name}-whq-b9f1ec8.patch
Patch7727:      %{whq_url}/965ebac6c19c72c511d61cc44958a3b944d5ddbf#/%{name}-whq-965ebac.patch
Patch7728:      %{whq_url}/67f7d6872b4e970e212f1ac4a51f21a3b8d00548#/%{name}-whq-67f7d68.patch
Patch7729:      %{whq_url}/8c5638aa5e7cfcd5b2844853e744702331a85a17#/%{name}-whq-8c5638a.patch
Patch7730:      %{whq_url}/6946d78ed9e88536951357ae5574e251f0007006#/%{name}-whq-6946d78.patch
Patch7731:      %{whq_url}/ab9ded062fe39ba16ea42ed3e1b755975e025853#/%{name}-whq-ab9ded0.patch
Patch7732:      %{whq_url}/50e2c62a60cad6af121335b7746c33ebafbf1d0a#/%{name}-whq-50e2c62.patch
Patch7733:      %{whq_url}/6cf3561ff3df814e7450d63769620441e4ea1265#/%{name}-whq-6cf3561.patch
Patch7734:      %{whq_url}/d694928ec25071e87cf02422e5ee3a1acdad872f#/%{name}-whq-d694928.patch
Patch7735:      %{whq_url}/2379e3c18119ce258daad51c2d8212da7512013d#/%{name}-whq-2379e3c.patch
Patch7736:      %{whq_url}/d0bea3d70207587f183bcad0e40cfeba8668c6fb#/%{name}-whq-d0bea3d.patch
Patch7737:      %{whq_url}/fa1b0fcf6cde6e1f7f5c9782457eb8d7f7b9eff3#/%{name}-whq-fa1b0fc.patch
Patch7738:      %{whq_url}/e5d780272951426de174671d2e581a39946f2a6d#/%{name}-whq-e5d7802.patch
Patch7739:      %{whq_url}/f3b8ccb2f79c9b4801493898a63a2520bc43afd4#/%{name}-whq-f3b8ccb.patch
Patch7740:      %{whq_url}/0e3edfd9422b811bc9b4c90110133fa342ae204e#/%{name}-whq-0e3edfd.patch
Patch7741:      %{whq_url}/c440926547a8c790badce1b9bcdfcea7183ed1a0#/%{name}-whq-c440926.patch
Patch7742:      %{whq_url}/5f24f3012469f7056aa9b22765af1c0f11e1f6a2#/%{name}-whq-5f24f30.patch
Patch7743:      %{whq_url}/8fb897a5718767bb86c734c8ea90245aeb7bee47#/%{name}-whq-8fb897a.patch
Patch7744:      %{whq_url}/c6806e3f204413294bd16a7b93dc5893bc00fe83#/%{name}-whq-c6806e3.patch
Patch7745:      %{whq_url}/c2b089aae52c1d275098e1e8b87c0f9a5340b206#/%{name}-whq-c2b089a.patch
Patch7746:      %{whq_url}/088b7c5814e8aee5676d0c999a2995533f21a4ed#/%{name}-whq-088b7c5.patch
Patch7747:      %{whq_url}/2a573c6f4899e7ccdb0492ba5029c7f8506590e4#/%{name}-whq-2a573c6.patch
Patch7748:      %{whq_url}/8db14f4e18a3770b4ac3cfe6e1ddbe17dec342d7#/%{name}-whq-8db14f4.patch
Patch7749:      %{whq_url}/e055a3ee0503a62d1d0c1391b01471c13fad6bd3#/%{name}-whq-e055a3e.patch
Patch7750:      %{whq_url}/9fff80d87655ae9f70094b34661abc2a399395be#/%{name}-whq-9fff80d.patch
Patch7751:      %{whq_url}/6a19b999f7877f5b0052c77d09a41635769ce441#/%{name}-whq-6a19b99.patch
Patch7752:      %{whq_url}/48e88074cdd09513164f8669b270d13425f4584c#/%{name}-whq-48e8807.patch
Patch7753:      %{whq_url}/20e0fd6e991edf5c6b5c6c7c22632d16d346a690#/%{name}-whq-20e0fd6.patch
Patch7754:      %{whq_url}/7cec3dc28492f2d43d706cde9afa4fcbc4ae87c4#/%{name}-whq-7cec3dc.patch
Patch7755:      %{whq_url}/e5c0e8e296a114aeca41fcb67c73f55e1d37d002#/%{name}-whq-e5c0e8e.patch
Patch7756:      %{whq_url}/0c631ebb2354334eaf309bc0765d3283654cf902#/%{name}-whq-0c631eb.patch
Patch7757:      %{whq_url}/fde5967f725624c5ee4995dcbe22f262979c5c9c#/%{name}-whq-fde5967.patch
Patch7758:      %{whq_url}/559d502699a477c00944284bb9ef7677ce6b8f18#/%{name}-whq-559d502.patch
Patch7759:      %{whq_url}/f4d376ea07c3797d31ff918b3e93129655ef670e#/%{name}-whq-f4d376e.patch
Patch7760:      %{whq_url}/02a764e702094572186e079f6d48946627336d03#/%{name}-whq-02a764e.patch
Patch7761:      %{whq_url}/9498f9625a7b4b704f10b1bb321685371b0c999f#/%{name}-whq-9498f96.patch
Patch7762:      %{whq_url}/0c2f556afe7b5fcc873c737512fae5b9c8c07624#/%{name}-whq-0c2f556.patch
Patch7763:      %{whq_url}/d6da10f3fb97f412ccb1ea4a806b13be3a0475e2#/%{name}-whq-d6da10f.patch
Patch7764:      %{whq_url}/d70c8e464a56a17f5c0669ff668fb1070781faa6#/%{name}-whq-d70c8e4.patch
Patch7765:      %{whq_url}/54c1b0ac267abd0e52f23a60143999af2cd49b03#/%{name}-whq-54c1b0a.patch
Patch7766:      %{whq_url}/b8ada902d12f628883c790cdef3bacf5853a7f81#/%{name}-whq-b8ada90.patch
Patch7767:      %{whq_url}/459046561328735dfe75181ecd825410747c6451#/%{name}-whq-4590465.patch
Patch7768:      %{whq_url}/f0e13847779fe058b655c8ec1a20f61b431f7df2#/%{name}-whq-f0e1384.patch
Patch7769:      %{whq_url}/209b968efc2336a72f5223f0c73ff46f11a2f1ba#/%{name}-whq-209b968.patch
Patch7770:      %{whq_url}/a472ad191f3f518feb9e100a20cee835e3109561#/%{name}-whq-a472ad1.patch
Patch7771:      %{whq_url}/c4383013aab04ecaf2aaf969ec6158d28c0c7f02#/%{name}-whq-c438301.patch
Patch7772:      %{whq_url}/0167e195e962a427c247e3442abf6ea23fd36156#/%{name}-whq-0167e19.patch
Patch7773:      %{whq_url}/e16018f621e93de37f5b85b29bafe44cfa6c1b3c#/%{name}-whq-e16018f.patch
Patch7774:      %{whq_url}/c955eee9e8ba92118f2192578128d4756030c7a4#/%{name}-whq-c955eee.patch
Patch7775:      %{whq_url}/0627fa9d9217c18278c8ea9c96740815b70d850f#/%{name}-whq-0627fa9.patch
Patch7776:      %{whq_url}/e596f4047ba5cc08a8324756f04851e09e8f629b#/%{name}-whq-e596f40.patch
Patch7777:      %{whq_url}/defcbc8b97e45d879deb366dc32a1c1c5f5fac8c#/%{name}-whq-defcbc8.patch
Patch7778:      %{whq_url}/abcc75cbcf57513f07ab8c008f66a19f142c5a7b#/%{name}-whq-abcc75c.patch
Patch7779:      %{whq_url}/ac36b8ff01be8e6e6c8f46096b434f7048097559#/%{name}-whq-ac36b8f.patch
Patch7780:      %{whq_url}/b1f2b61be040cccaf6da6e6296bd38a24f05f55e#/%{name}-whq-b1f2b61.patch
Patch7781:      %{whq_url}/cb5edb4b12eb4846df85de71b889959a96586720#/%{name}-whq-cb5edb4.patch
Patch7782:      %{whq_url}/797f11612016205f78278f1e39f622e2f98d41b0#/%{name}-whq-797f116.patch
Patch7783:      %{whq_url}/da8e4d9cc98859d524924af11e1fe5ff00d43dc2#/%{name}-whq-da8e4d9.patch
Patch7784:      %{whq_url}/45b8489ba5a1726cb9d0e163de41cb1c0ddaa23b#/%{name}-whq-45b8489.patch
Patch7785:      %{whq_url}/c9e1b789d285fc43c1d8142eb8b4f2fe969c6c45#/%{name}-whq-c9e1b78.patch
Patch7786:      %{whq_url}/95e1de8215ce8b0ece486dcf8c713e98d5dd3a0f#/%{name}-whq-95e1de8.patch
Patch7787:      %{whq_url}/fa9f4a20f5305b7cbcfe3a644d39d4b759f89203#/%{name}-whq-fa9f4a2.patch
Patch7788:      %{whq_url}/5474c035e7dca04b0c9c2abba9d208c18e839b26#/%{name}-whq-5474c03.patch
Patch7789:      %{whq_url}/c46ab05e55860a6c2ea774495c9da8adff3eea00#/%{name}-whq-c46ab05.patch
Patch7790:      %{whq_url}/cb1594cf4ff9eef0a5b5d80dc7c47da9e27a5821#/%{name}-whq-cb1594c.patch
Patch7791:      %{whq_url}/ea038894a6aa4b034e151e4f2af42da36710e180#/%{name}-whq-ea03889.patch
Patch7792:      %{whq_url}/2600ccf27f9dfb6eadbb21c92b75618ccbd26e01#/%{name}-whq-2600ccf.patch
Patch7793:      %{whq_url}/e3ea5278357698e75b6cd51627c30e84e16845ca#/%{name}-whq-e3ea527.patch
Patch7794:      %{whq_url}/df794f342500f1b4bfd988f292302afa890354c1#/%{name}-whq-df794f3.patch
Patch7795:      %{whq_url}/bd27af974a21085cd0dc78b37b715bbcc3cfab69#/%{name}-whq-bd27af9.patch
Patch7796:      %{whq_url}/dcf3874e005f864a87205bb7da7ac4bda24a81b7#/%{name}-whq-dcf3874.patch
Patch7797:      %{whq_url}/973b0e1dfcfb20fe5ac2713721a4844e3e3c0671#/%{name}-whq-973b0e1.patch
Patch7798:      %{whq_url}/8bfdc84a1994274e5d7ee44c4ee3892666f4cdc7#/%{name}-whq-8bfdc84.patch
Patch7799:      %{whq_url}/f65340704f72d44ba64a6c7b430ca73076456086#/%{name}-whq-f653407.patch
Patch7800:      %{whq_url}/ee38e167d1280777c92c757f60d1609bca9e105a#/%{name}-whq-ee38e16.patch
Patch7801:      %{whq_url}/94ea4252cf3fd3613c8fe78b9af3f36609a3d8c2#/%{name}-whq-94ea425.patch
Patch7802:      %{whq_url}/ecc790ad479958d0c9a5af105463cfc3da3c3126#/%{name}-whq-ecc790a.patch
Patch7803:      %{whq_url}/b09acd526d0093962131ff900445cc2dae1f33c4#/%{name}-whq-b09acd5.patch
Patch7804:      %{whq_url}/0a6e46e4367e10caa0b13156d89807c45a5bc3ca#/%{name}-whq-0a6e46e.patch
Patch7805:      %{whq_url}/ab0a7d2a1b31160134d9205236fade162f0bc1dc#/%{name}-whq-ab0a7d2.patch
Patch7806:      %{whq_url}/7d54f9a87f337276fb5c328872951e485cdc37af#/%{name}-whq-7d54f9a.patch
Patch7807:      %{whq_url}/a729efb964bf193783d4090dcfe9864f877bb424#/%{name}-whq-a729efb.patch
Patch7808:      %{whq_url}/2a91b0bead7e5c6d08e3a6b79a6feda242e66652#/%{name}-whq-2a91b0b.patch
Patch7809:      %{whq_url}/f79ca651aeff14a7f4e3443410a89441569ea080#/%{name}-whq-f79ca65.patch
Patch7810:      %{whq_url}/886acfad379b653e4370e8172c5f7fae257b627c#/%{name}-whq-886acfa.patch
Patch7811:      %{whq_url}/a692d49039a584e28fa72689411f1ba71033abb9#/%{name}-whq-a692d49.patch
Patch7812:      %{whq_url}/a90017845d2f65ecd8c1bd32c3019bcd2b13ecd1#/%{name}-whq-a900178.patch
Patch7813:      %{whq_url}/1d2c29dfb0bac8915b8e2ea07ecf20a33ca89527#/%{name}-whq-1d2c29d.patch
Patch7814:      %{whq_url}/f377ac1f2d0751c9d2d79e061b4e9c378a856bbe#/%{name}-whq-f377ac1.patch
Patch7815:      %{whq_url}/0c25f5ee466b181e9caa6b15257be1db8a66b602#/%{name}-whq-0c25f5e.patch
Patch7816:      %{whq_url}/06cbf1992313f4a9ef090a4d01aaab42f74e8549#/%{name}-whq-06cbf19.patch
Patch7817:      %{whq_url}/36981ad03356caf01eb7e446765e1e9c023c0195#/%{name}-whq-36981ad.patch
Patch7818:      %{whq_url}/905deff5da48c085bb4213d3c67ecf1cfae45564#/%{name}-whq-905deff.patch
Patch7819:      %{whq_url}/767fa07092cde0bbf3f08a8c728dced8cb28c748#/%{name}-whq-767fa07.patch
Patch7820:      %{whq_url}/87ea7698ab8c859f0b7e4f363339b0b15c31abd5#/%{name}-whq-87ea769.patch
Patch7821:      %{whq_url}/4039c5ad47a999a771120091ca57d087b01ee382#/%{name}-whq-4039c5a.patch
Patch7822:      %{whq_url}/bbd4196814e9aa262112b338bfa976a575e64e65#/%{name}-whq-bbd4196.patch
Patch7823:      %{whq_url}/3d51714ce4d40506f9935e17e635f6d35be3057e#/%{name}-whq-3d51714.patch
Patch7824:      %{whq_url}/5c45ec90ffa8ee2f9472a9149258dd174309e203#/%{name}-whq-5c45ec9.patch
Patch7825:      %{whq_url}/7d48e0c564ef9a65608c01cc55657734f7d5004e#/%{name}-whq-7d48e0c.patch
Patch7826:      %{whq_url}/632676d071a936199d6d91d804f2e62321c870f7#/%{name}-whq-632676d.patch
Patch7827:      %{whq_url}/c2ffbe5d364d07971e0c893c6d52e5606dfbaef7#/%{name}-whq-c2ffbe5.patch
Patch7828:      %{whq_url}/3a6da8defa65e6615e9f29e5c600e62cea0a9bd4#/%{name}-whq-3a6da8d.patch
Patch7829:      %{whq_url}/d2aa17dceeee847541f210ce8e68f1724f0316d8#/%{name}-whq-d2aa17d.patch
Patch7830:      %{whq_murl}/commit/6323e36f0f1b85180314027f84cb3c37140bcb70.patch#/%{name}-whq-6323e36.patch
Patch7831:      %{whq_url}/7148521305b161129c43b806d83c9a46aa42cbca#/%{name}-whq-7148521.patch
Patch7832:      %{whq_url}/91be31b28ad5ae4852d2cc3cc3bcfc3e2ee01895#/%{name}-whq-91be31b.patch
Patch7833:      %{whq_murl}/commit/627ae12d2de39695d244aead531a91d1a5fbf79d.patch#/%{name}-whq-627ae12.patch
Patch7834:      %{whq_url}/83b52b19b5324adf8782cb3b1fd23c9bbe86c8aa#/%{name}-whq-83b52b1.patch
Patch7835:      %{whq_url}/aabd2b54b2c538b74d2eb1026c7afdf2f910f253#/%{name}-whq-aabd2b5.patch
Patch7836:      %{whq_url}/a3583f05055b5093a3a8822b73fb24281ae62d27#/%{name}-whq-a3583f0.patch
Patch7837:      %{whq_url}/1333aebe0b3d7a8654a9c573b3dc24d7aa31c1c9#/%{name}-whq-1333aeb.patch
Patch7838:      %{whq_url}/b2487c17eb60424e1cb4a74e4763f057ebbf7f39#/%{name}-whq-b2487c1.patch
Patch7839:      %{whq_url}/12cc863a4a5e31a01bf4f683d94a7e155feb23ea#/%{name}-whq-12cc863.patch
Patch7840:      %{whq_url}/859b526c81a2af841b5b7b28d06f3d782bccdab5#/%{name}-whq-859b526.patch
Patch7841:      %{whq_murl}/commit/627d31fcd9fa1e4657c781ca07ff25e437101820.patch#/%{name}-whq-627d31f.patch
Patch7842:      %{whq_url}/53f7cb3c0888c852e0b4fdc9366c6ce53a54f433#/%{name}-whq-53f7cb3.patch
Patch7843:      %{whq_url}/143c210360ab4b3232fc5cdbf5c5c56d8001ace4#/%{name}-whq-143c210.patch
Patch7844:      %{whq_url}/633b244b1ae7928cafbfd25ef338e4918aac0d74#/%{name}-whq-633b244.patch
Patch7845:      %{whq_url}/98dcd3a7ead292eee3cdd1825380ccbb8a69dbc9#/%{name}-whq-98dcd3a.patch
Patch7846:      %{whq_url}/eca4d91cad48922f0ec881f79913e4b0162adbec#/%{name}-whq-eca4d91.patch
Patch7847:      %{whq_url}/1b672d1013056d6a017605b8f8b7a8aca7ff16cd#/%{name}-whq-1b672d1.patch
Patch7848:      %{whq_url}/dc6f6e9ef3d6f9c99eb743d779174e5759f091e9#/%{name}-whq-dc6f6e9.patch
Patch7849:      %{whq_url}/2e74000537a947e29c6de9de53bbfb1549649f87#/%{name}-whq-2e74000.patch
Patch7850:      %{whq_url}/c2e319ed20d3e0e5b263960edff237702896e1f8#/%{name}-whq-c2e319e.patch
Patch7851:      %{whq_url}/cf20e80f8d962ab043cae2a46f1be583d0013214#/%{name}-whq-cf20e80.patch
Patch7852:      %{whq_url}/c58802d0f46860572b7c42818cf8681119d4db7e#/%{name}-whq-c58802d.patch
Patch7853:      %{whq_url}/7341f4ad1e771f32d8276734774bfa9ba352f259#/%{name}-whq-7341f4a.patch
Patch7854:      %{whq_url}/ec1ea1ea1b2469a526f4bbc38aab404b7a2b062c#/%{name}-whq-ec1ea1e.patch
Patch7855:      %{whq_url}/419abd49a1f816e5a869dbf4cc81114cd516138b#/%{name}-whq-419abd4.patch
Patch7856:      %{whq_url}/4e52f7ca865abf22c299501447805ab435399e27#/%{name}-whq-4e52f7c.patch
Patch7857:      %{whq_url}/fa409a91b0f13e478a43c9adc84d3c870bbae432#/%{name}-whq-fa409a9.patch
Patch7858:      %{whq_url}/f7edc328184c4755c81dec5372b3ae5ac7b8c5df#/%{name}-whq-f7edc32.patch
Patch7859:      %{whq_url}/6decf1730509b9aa697e0fd4c6fdd5da63c9af37#/%{name}-whq-6decf17.patch
Patch7860:      %{whq_url}/a40474fa18b1c3a8cd95719328420f7a8e6b7682#/%{name}-whq-a40474f.patch
Patch7861:      %{whq_url}/70c1d4fcaa846a8f69ef21d0a5b2c070c668b589#/%{name}-whq-70c1d4f.patch
Patch7862:      %{whq_url}/1668db80abe44a833ab3de888d235be53a02f0dd#/%{name}-whq-1668db8.patch
Patch7863:      %{whq_url}/d3f09b862a3f6b19bbfeba7183c2ced06c030f72#/%{name}-whq-d3f09b8.patch
Patch7864:      %{whq_url}/a7066c66a646a828c16c33e67174ea1918053eac#/%{name}-whq-a7066c6.patch
Patch7865:      %{whq_url}/bed3b61b498af5339f53ecc23937ff3b81b196d1#/%{name}-whq-bed3b61.patch
Patch7866:      %{whq_url}/d7e831c1123cca7785a6b8813f4991b42f9473e2#/%{name}-whq-d7e831c.patch
Patch7867:      %{whq_url}/ef2e281dc26c4eb4fb4bc09deb3b3dbf5f2e73fe#/%{name}-whq-ef2e281.patch
Patch7868:      %{whq_url}/e909986e6ea5ecd49b2b847f321ad89b2ae4f6f1#/%{name}-whq-e909986.patch
Patch7869:      %{whq_url}/892780a5d255136622f6c6402545cc85110be057#/%{name}-whq-892780a.patch
Patch7870:      %{whq_url}/54c31d5332a71d785db1b73cf3be41818adeab8a#/%{name}-whq-54c31d5.patch
Patch7871:      %{whq_url}/591cb80dea8c094539b4bc4ab640b00538c6e06a#/%{name}-whq-591cb80.patch
Patch7872:      %{whq_url}/6f05b299bce211ef11dd5b046da4247e111cb91d#/%{name}-whq-6f05b29.patch
Patch7873:      %{whq_url}/ea8fa3174cba57df1120438724ddb8d41442c2ea#/%{name}-whq-ea8fa31.patch
Patch7874:      %{whq_url}/746ece1a086f8fb721766fc8a4677606e722e4c2#/%{name}-whq-746ece1.patch
Patch7875:      %{whq_url}/7fe55d2f7a66d60f3bf4890f59311920f1cc3608#/%{name}-whq-7fe55d2.patch
Patch7876:      %{whq_url}/01c17ca26027d055c5e983c8d76d60647bf7f24d#/%{name}-whq-01c17ca.patch
Patch7877:      %{whq_url}/1d8c2d28cb2ec313d1b5c1f762624be776a3dca7#/%{name}-whq-1d8c2d2.patch

Patch7878:      %{whq_url}/d1461b622eaf5acd1515e9c8925134e6d878d3fe#/%{name}-whq-d1461b6.patch
Patch7879:      %{whq_url}/102c7903ead405d3236dfd843d40b96c38d784ab#/%{name}-whq-102c790.patch
Patch7880:      %{whq_url}/ff8b5a51d7e961ec506d1695a139c0a6079a3fd4#/%{name}-whq-ff8b5a5.patch
Patch7881:      %{whq_url}/2aebe0b628a171abd2ffb63054e3d3d0da60dd05#/%{name}-whq-2aebe0b.patch
Patch7882:      %{whq_url}/0c249e6125fc9dc6ee86b4ef6ae0d9fa2fc6291b#/%{name}-whq-0c249e6.patch
...
Patch801:       %{tkg_url}/hotfixes/01150d7f/06877e55b1100cc49d3726e9a70f31c4dfbe66f8-113.mystagingpatch#/%{name}-tkg-06877e5_revert-113.patch
...
Patch808:       %{tkg_url}/hotfixes/01150d7f/001-8db14f4e18a3770b4ac3cfe6e1ddbe17dec342d7.myearlypatch#/%{name}-tkg-001-8db14f4_early.patch
Patch809:       %{tkg_url}/hotfixes/01150d7f/001-f7edc328184c4755c81dec5372b3ae5ac7b8c5df.myearlypatch#/%{name}-tkg-001-f7edc32_early.patch
...
Patch1094:       %{tkg_url}/hotfixes/01150d7f/Updated_wow64cpu-Wow64Transition.mypatch#/%{name}-tkg-Updated_wow64cpu-Wow64Transition.patch
Patch1095:       %{tkg_url}/hotfixes/01150d7f/ntdll-ThreadHideFromDebugger.mypatch#/%{name}-tkg-ntdll-ThreadHideFromDebugger.patch
Patch1096:       %{tkg_url}/hotfixes/01150d7f/origin_3078f10d_fix.mypatch#/%{name}-tkg-origin_3078f10d_fix.patch
Patch1097:       %{tkg_url}/hotfixes/01150d7f/001-SMBIOS-0720c6cf.mypatch#/%{name}-tkg-001-SMBIOS-0720c6c.patch
Patch1098:       %{tkg_url}/hotfixes/01150d7f/002-SMBIOS-d29c33a3.mypatch#/%{name}-tkg-002-SMBIOS-d29c33a3.patch
Patch1099:       %{tkg_url}/hotfixes/01150d7f/001-8622eb326fb8120fc038e27947e61677d4124f15-staging.mypatch#/%{name}-tkg-001-8622eb3-staging.patch
Patch1100:       0001-hotfix-rebased-f2d60c1.patch
Patch1101:       %{tkg_url}/hotfixes/370a538e/xact-revert-179.myrevert#/%{name}-tkg-xact-revert-179.patch
...
%endif
%{_bindir}/msidb
#FIXME: remove when fsync reverts are not needed
...
#FIXME: change to PE when fsync reverts are not needed
