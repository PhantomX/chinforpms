...
Source:         https://download.gnome.org/sources/%{name}/%(echo %{version} | cut -d. -f-2)/%{name}-%{version}.tar.xz
...
%changelog
* Thu Mar 16 2023 Phantom X <megaphantomx at hotmail dot com> - 1:3.44.0-100
- Maintain gtk3 build with Epoch
