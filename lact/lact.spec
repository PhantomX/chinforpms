...
%global vendor_hash 87aade81e9901716615f21e949dae771

%global cl3_ver 0.13.1
...
%if %{with vendor}
# cargo vendor-filterer --platform=x86_64-unknown-linux-gnu && tar --numeric-owner -cvJf ../%%{name}-%%{version}-vendor.tar.xz vendor/
...
Provides:       bundled(crate(aho)) = 1.1.4
Provides:       bundled(crate(allocator)) = 0.2.21
Provides:       bundled(crate(amdgpu)) = 0.19.3
...
Provides:       bundled(crate(anstyle)) = 0.2.7
Provides:       bundled(crate(anstyle)) = 1.1.5
Provides:       bundled(crate(anstyle)) = 3.0.11
Provides:       bundled(crate(anyhow)) = 1.0.100
Provides:       bundled(crate(arc)) = 1.7.1
Provides:       bundled(crate(async)) = 0.7.2
Provides:       bundled(crate(async)) = 1.1.1
Provides:       bundled(crate(async)) = 0.1.89
Provides:       bundled(crate(autocfg)) = 1.5.0
Provides:       bundled(crate(base64)) = 0.22.1
Provides:       bundled(crate(basic)) = 0.1.10
...
Provides:       bundled(crate(cairo)) = 0.21.2
Provides:       bundled(crate(cairo)) = 0.21.2
Provides:       bundled(crate(cc)) = 1.2.47
Provides:       bundled(crate(cexpr)) = 0.6.0
Provides:       bundled(crate(cfg_aliases)) = 0.2.1
Provides:       bundled(crate(cfg)) = 0.20.4
Provides:       bundled(crate(cfg)) = 1.0.4
Provides:       bundled(crate(chrono)) = 0.4.42
Provides:       bundled(crate(cl3)) = 0.13.1
Provides:       bundled(crate(clang)) = 1.8.1
...
Provides:       bundled(crate(crypto)) = 0.1.7
...
Provides:       bundled(crate(divan)) = 0.1.21
Provides:       bundled(crate(dlopen2)) = 0.8.0
Provides:       bundled(crate(dlopen2_derive)) = 0.4.1
Provides:       bundled(crate(document)) = 0.2.12
Provides:       bundled(crate(easy_fuser)) = 0.4.2
...
Provides:       bundled(crate(event)) = 5.4.1
Provides:       bundled(crate(event)) = 0.5.4
Provides:       bundled(crate(fastrand)) = 2.3.0
Provides:       bundled(crate(field)) = 0.3.6
Provides:       bundled(crate(filetime)) = 0.2.26
Provides:       bundled(crate(find)) = 0.6.3
Provides:       bundled(crate(find)) = 0.1.5
Provides:       bundled(crate(flate2)) = 1.1.5
Provides:       bundled(crate(fluent)) = 0.17.0
Provides:       bundled(crate(fluent)) = 0.16.0
Provides:       bundled(crate(fluent)) = 0.13.1
Provides:       bundled(crate(fluent)) = 0.12.0
...
Provides:       bundled(crate(futures)) = 0.3.31
Provides:       bundled(crate(futures)) = 0.3.31
Provides:       bundled(crate(futures)) = 2.6.1
Provides:       bundled(crate(futures)) = 0.3.31
Provides:       bundled(crate(futures)) = 0.3.31
Provides:       bundled(crate(futures)) = 0.3.31
Provides:       bundled(crate(futures)) = 0.3.31
Provides:       bundled(crate(gdk4)) = 0.10.1
Provides:       bundled(crate(gdk4)) = 0.10.1
Provides:       bundled(crate(gdk)) = 0.21.2
Provides:       bundled(crate(gdk)) = 0.21.2
Provides:       bundled(crate(generic)) = 0.14.7
Provides:       bundled(crate(getrandom)) = 0.2.16
Provides:       bundled(crate(getrandom)) = 0.3.4
Provides:       bundled(crate(gio)) = 0.21.4
Provides:       bundled(crate(gio)) = 0.21.2
Provides:       bundled(crate(glib)) = 0.21.4
Provides:       bundled(crate(glib)) = 0.21.4
Provides:       bundled(crate(glib)) = 0.21.2
Provides:       bundled(crate(glob)) = 0.3.3
Provides:       bundled(crate(gobject)) = 0.21.2
Provides:       bundled(crate(graphene)) = 0.21.2
Provides:       bundled(crate(graphene)) = 0.21.2
Provides:       bundled(crate(gsk4)) = 0.10.1
Provides:       bundled(crate(gsk4)) = 0.10.1
Provides:       bundled(crate(gtk4)) = 0.10.2
Provides:       bundled(crate(gtk4)) = 0.10.1
Provides:       bundled(crate(gtk4)) = 0.10.1
Provides:       bundled(crate(hashbrown)) = 0.16.1
Provides:       bundled(crate(heck)) = 0.5.0
Provides:       bundled(crate(hermit)) = 0.5.2
Provides:       bundled(crate(hex)) = 0.4.3
Provides:       bundled(crate(http)) = 1.4.0
Provides:       bundled(crate(httparse)) = 1.10.1
Provides:       bundled(crate(i18n)) = 0.4.8
Provides:       bundled(crate(i18n)) = 0.16.0
Provides:       bundled(crate(i18n)) = 0.10.0
Provides:       bundled(crate(i18n)) = 0.8.4
Provides:       bundled(crate(iana)) = 0.1.64
...
Provides:       bundled(crate(icu_properties)) = 2.1.1
Provides:       bundled(crate(icu_properties_data)) = 2.1.1
...
Provides:       bundled(crate(inotify)) = 0.1.5
Provides:       bundled(crate(insta)) = 1.44.1
Provides:       bundled(crate(intl)) = 0.5.3
...
Provides:       bundled(crate(js)) = 0.3.82
Provides:       bundled(crate(kqueue)) = 1.1.1
Provides:       bundled(crate(kqueue)) = 1.0.4
Provides:       bundled(crate(lazy_static)) = 1.5.0
Provides:       bundled(crate(libadwaita)) = 0.8.0
Provides:       bundled(crate(libadwaita)) = 0.8.0
Provides:       bundled(crate(libc)) = 0.2.177
...
Provides:       bundled(crate(libredox)) = 0.1.10
Provides:       bundled(crate(linux)) = 0.11.0
...
Provides:       bundled(crate(mio)) = 1.1.0
...
Provides:       bundled(crate(notify)) = 2.0.0
Provides:       bundled(crate(nu)) = 0.50.3
...
Provides:       bundled(crate(nvml)) = 0.11.0
Provides:       bundled(crate(nvml)) = 0.9.0
Provides:       bundled(crate(once_cell)) = 1.21.3
Provides:       bundled(crate(once_cell_polyfill)) = 1.70.2
Provides:       bundled(crate(opencl)) = 0.6.1
Provides:       bundled(crate(ordered)) = 0.2.0
Provides:       bundled(crate(os)) = 0.1.0
Provides:       bundled(crate(page_size)) = 0.6.0
Provides:       bundled(crate(pango)) = 0.21.3
Provides:       bundled(crate(pango)) = 0.21.2
...
Provides:       bundled(crate(pciid)) = 0.8.0
Provides:       bundled(crate(percent)) = 2.3.2
...
Provides:       bundled(crate(plotters)) = 0.3.7
Provides:       bundled(crate(plotters)) = 0.8.0
...
Provides:       bundled(crate(proc)) = 1.0.103
Provides:       bundled(crate(proc)) = 3.4.0
Provides:       bundled(crate(proc)) = 2.0.1
Provides:       bundled(crate(proc)) = 2.0.0
Provides:       bundled(crate(quote)) = 1.0.42
Provides:       bundled(crate(redox_syscall)) = 0.5.18
Provides:       bundled(crate(r)) = 5.3.0
Provides:       bundled(crate(regex)) = 1.12.2
Provides:       bundled(crate(regex)) = 0.4.13
Provides:       bundled(crate(regex)) = 0.1.8
Provides:       bundled(crate(regex)) = 0.8.8
Provides:       bundled(crate(relm4)) = 0.10.0
Provides:       bundled(crate(relm4)) = 0.10.0
Provides:       bundled(crate(relm4)) = 0.10.0
Provides:       bundled(crate(relm4)) = 0.10.0
Provides:       bundled(crate(ring)) = 0.17.14
Provides:       bundled(crate(rle)) = 1.0.3
Provides:       bundled(crate(rustc)) = 2.1.1
Provides:       bundled(crate(rustc_version)) = 0.4.1
Provides:       bundled(crate(rust)) = 8.9.0
Provides:       bundled(crate(rust)) = 8.9.0
Provides:       bundled(crate(rust)) = 8.9.0
Provides:       bundled(crate(rustix)) = 1.1.2
Provides:       bundled(crate(rustls)) = 0.23.35
Provides:       bundled(crate(rustls)) = 1.13.0
Provides:       bundled(crate(rustls)) = 0.103.8
...
Provides:       bundled(crate(serde)) = 0.1.3
...
Provides:       bundled(crate(serde_with)) = 3.16.0
Provides:       bundled(crate(serde_with_macros)) = 3.16.0
Provides:       bundled(crate(sha2)) = 0.10.9
Provides:       bundled(crate(sharded)) = 0.1.7
Provides:       bundled(crate(shlex)) = 1.3.0
Provides:       bundled(crate(signal)) = 1.4.7
...
Provides:       bundled(crate(sys)) = 0.3.2
Provides:       bundled(crate(system)) = 7.0.7
Provides:       bundled(crate(tar)) = 0.4.44
Provides:       bundled(crate(target)) = 0.13.3
Provides:       bundled(crate(tempfile)) = 3.23.0
...
Provides:       bundled(crate(tracing)) = 0.1.34
Provides:       bundled(crate(tracing)) = 0.2.0
Provides:       bundled(crate(tracing)) = 0.3.20
Provides:       bundled(crate(tracker)) = 0.2.2
Provides:       bundled(crate(tracker)) = 0.2.2
Provides:       bundled(crate(type)) = 0.5.1
Provides:       bundled(crate(typenum)) = 1.19.0
Provides:       bundled(crate(uds_windows)) = 1.1.0
Provides:       bundled(crate(unic)) = 0.9.6
Provides:       bundled(crate(unic)) = 0.9.6
Provides:       bundled(crate(unicode)) = 1.0.22
Provides:       bundled(crate(unsafe)) = 0.2.15
Provides:       bundled(crate(untrusted)) = 0.9.0
Provides:       bundled(crate(ureq)) = 3.1.4
Provides:       bundled(crate(ureq)) = 0.5.3
Provides:       bundled(crate(url)) = 2.5.7
Provides:       bundled(crate(utf)) = 0.7.6
...
Provides:       bundled(crate(version)) = 0.2.1
Provides:       bundled(crate(walkdir)) = 2.5.0
Provides:       bundled(crate(wasi)) = preview1
Provides:       bundled(crate(wasip2)) = 0.2.4
Provides:       bundled(crate(wasm)) = 0.2.105
Provides:       bundled(crate(wasm)) = 0.2.105
Provides:       bundled(crate(wasm)) = 0.2.105
Provides:       bundled(crate(wasm)) = 0.2.105
Provides:       bundled(crate(webpki)) = 1.0.4
Provides:       bundled(crate(web)) = 0.3.82
Provides:       bundled(crate(winapi)) = 0.3.9
Provides:       bundled(crate(winapi)) = 0.4.0
Provides:       bundled(crate(winapi)) = 0.1.11
Provides:       bundled(crate(winapi)) = 0.4.0
...
Provides:       bundled(crate(windows)) = 0.61.2
Provides:       bundled(crate(windows)) = 0.62.2
Provides:       bundled(crate(windows)) = 0.2.1
...
Provides:       bundled(crate(windows)) = 0.60.2
Provides:       bundled(crate(windows)) = 0.59.3
Provides:       bundled(crate(windows)) = 0.1.3
Provides:       bundled(crate(windows)) = 0.2.1
Provides:       bundled(crate(windows)) = 0.2.0
Provides:       bundled(crate(windows)) = 0.3.4
Provides:       bundled(crate(windows)) = 0.4.1
Provides:       bundled(crate(windows)) = 0.4.2
Provides:       bundled(crate(windows)) = 0.5.1
Provides:       bundled(crate(windows)) = 0.52.0
Provides:       bundled(crate(windows)) = 0.59.0
Provides:       bundled(crate(windows)) = 0.60.2
Provides:       bundled(crate(windows)) = 0.61.2
Provides:       bundled(crate(windows)) = 0.52.6
Provides:       bundled(crate(windows)) = 0.53.5
...
Provides:       bundled(crate(wit)) = 0.46.0
Provides:       bundled(crate(wrapcenum)) = 0.4.1
...
Provides:       bundled(crate(zerocopy)) = 0.8.30
Provides:       bundled(crate(zerocopy)) = 0.8.30
...
Provides:       bundled(crate(zerovec)) = 0.11.2
...
sed -e 's|_RPM_CL3VER_|%{cl3_ver}|' -i lact-daemon/Cargo.toml
