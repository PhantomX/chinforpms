...
Provides:       bundled(crate(cfg-expr)) = 0.20.7
...
Provides:       bundled(crate(easy_fuser)) = 0.4.5
...
Provides:       bundled(crate(inotify)) = 0.11.1
Provides:       bundled(crate(inotify-sys)) = 0.1.5
Provides:       bundled(crate(insta)) = 1.47.2
...
Provides:       bundled(crate(no_std_io2)) = 0.9.3
...
Provides:       bundled(crate(relm4)) = 0.10.1
Provides:       bundled(crate(relm4-components)) = 0.10.1
Provides:       bundled(crate(relm4-css)) = 0.10.1
Provides:       bundled(crate(relm4-macros)) = 0.10.1
...
Provides:       bundled(crate(rustls)) = 0.23.38
...
Provides:       bundled(crate(serde_with)) = 3.18.0
Provides:       bundled(crate(serde_with_macros)) = 3.18.0
...
Provides:       bundled(crate(socket2)) = 0.6.3
...
Provides:       bundled(crate(tar)) = 0.4.45
