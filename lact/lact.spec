%global commit 86eb7fb414ca0ca4e73c3373b7027d4f55d02c1c
...
Provides:       bundled(crate(arc-swap)) = 1.9.2
Provides:       bundled(crate(askama)) = 0.15.6
Provides:       bundled(crate(askama_derive)) = 0.15.6
Provides:       bundled(crate(askama_macros)) = 0.15.6
Provides:       bundled(crate(askama_parser)) = 0.15.6
...
Provides:       bundled(crate(bimap)) = 0.6.3
Provides:       bundled(crate(bindgen)) = 0.71.1
Provides:       bundled(crate(bindgen)) = 0.72.1
Provides:       bundled(crate(bitflags)) = 1.3.2
Provides:       bundled(crate(bitflags)) = 2.13.0
Provides:       bundled(crate(block-buffer)) = 0.12.1
Provides:       bundled(crate(bon)) = 3.9.3
Provides:       bundled(crate(bon-macros)) = 3.9.3
Provides:       bundled(crate(bumpalo)) = 3.20.3
Provides:       bundled(crate(bytes)) = 1.12.1
Provides:       bundled(crate(cairo-rs)) = 0.22.0
Provides:       bundled(crate(cairo-sys-rs)) = 0.22.0
Provides:       bundled(crate(cc)) = 1.2.66
Provides:       bundled(crate(cexpr)) = 0.6.0
Provides:       bundled(crate(cfg_aliases)) = 0.2.1
Provides:       bundled(crate(cfg-expr)) = 0.20.8
...
Provides:       bundled(crate(console)) = 0.16.4
...
Provides:       bundled(crate(crossbeam-utils)) = 0.8.22
Provides:       bundled(crate(crypto-common)) = 0.2.2
...
Provides:       bundled(crate(dary_heap)) = 0.3.9
Provides:       bundled(crate(defmt)) = 1.1.1
Provides:       bundled(crate(defmt-macros)) = 1.1.1
Provides:       bundled(crate(defmt-parser)) = 1.0.0
Provides:       bundled(crate(deranged)) = 0.5.8
Provides:       bundled(crate(diff)) = 0.1.13
Provides:       bundled(crate(digest)) = 0.11.3
...
Provides:       bundled(crate(easy_fuser)) = 0.5.0
Provides:       bundled(crate(easy_fuser_macro)) = 0.1.0
...
Provides:       bundled(crate(gdk4)) = 0.11.4
Provides:       bundled(crate(gdk4-sys)) = 0.11.4
Provides:       bundled(crate(gdk-pixbuf)) = 0.22.0
Provides:       bundled(crate(gdk-pixbuf-sys)) = 0.22.0
Provides:       bundled(crate(getrandom)) = 0.2.17
Provides:       bundled(crate(getrandom)) = 0.3.4
Provides:       bundled(crate(getrandom)) = 0.4.3
Provides:       bundled(crate(gio)) = 0.22.8
Provides:       bundled(crate(gio-sys)) = 0.22.8
Provides:       bundled(crate(glib)) = 0.22.8
Provides:       bundled(crate(glib-macros)) = 0.22.6
Provides:       bundled(crate(glib-sys)) = 0.22.8
Provides:       bundled(crate(glob)) = 0.3.3
Provides:       bundled(crate(gobject-sys)) = 0.22.6
Provides:       bundled(crate(graphene-rs)) = 0.22.8
Provides:       bundled(crate(graphene-sys)) = 0.22.8
Provides:       bundled(crate(gsk4)) = 0.11.4
Provides:       bundled(crate(gsk4-sys)) = 0.11.4
Provides:       bundled(crate(gtk4)) = 0.11.4
Provides:       bundled(crate(gtk4-macros)) = 0.11.4
Provides:       bundled(crate(gtk4-sys)) = 0.11.4
...
Provides:       bundled(crate(hybrid-array)) = 0.4.13
Provides:       bundled(crate(i18n-config)) = 0.4.8
Provides:       bundled(crate(i18n-embed)) = 0.16.0
Provides:       bundled(crate(i18n-embed-fl)) = 0.10.1
...
Provides:       bundled(crate(inotify)) = 0.11.4
Provides:       bundled(crate(inotify-sys)) = 0.1.8
...
Provides:       bundled(crate(jiff)) = 0.2.32
Provides:       bundled(crate(jiff-static)) = 0.2.32
Provides:       bundled(crate(jiff-tzdb)) = 0.1.8
Provides:       bundled(crate(jiff-tzdb-platform)) = 0.1.3
Provides:       bundled(crate(js-sys)) = 0.3.103
Provides:       bundled(crate(kqueue)) = 1.2.0
Provides:       bundled(crate(kqueue-sys)) = 1.1.2
Provides:       bundled(crate(lazy_static)) = 1.5.0
Provides:       bundled(crate(libadwaita)) = 0.9.2
Provides:       bundled(crate(libadwaita-sys)) = 0.9.2
...
Provides:       bundled(crate(memchr)) = 2.8.3
...
Provides:       bundled(crate(nvml-wrapper)) = 0.12.1
Provides:       bundled(crate(nvml-wrapper-sys)) = 0.9.1
...
Provides:       bundled(crate(pango)) = 0.22.8
Provides:       bundled(crate(pango-sys)) = 0.22.0
...
Provides:       bundled(crate(pciid-parser)) = 0.8.1
...
Provides:       bundled(crate(plotters-cairo)) = 0.9.0
...
Provides:       bundled(crate(proc-macro-error3)) = 3.1.0
Provides:       bundled(crate(proc-macro-error-attr3)) = 3.1.0
...
Provides:       bundled(crate(regex)) = 1.13.0
Provides:       bundled(crate(regex-automata)) = 0.4.15
Provides:       bundled(crate(regex-lite)) = 0.1.9
Provides:       bundled(crate(regex-syntax)) = 0.8.11
Provides:       bundled(crate(relm4)) = 0.11.0
Provides:       bundled(crate(relm4-components)) = 0.11.0
Provides:       bundled(crate(relm4-css)) = 0.11.0
Provides:       bundled(crate(relm4-macros)) = 0.11.0
Provides:       bundled(crate(ring)) = 0.17.14
Provides:       bundled(crate(rle-decode-fast)) = 1.0.3
Provides:       bundled(crate(rustc-hash)) = 2.1.3
Provides:       bundled(crate(rustc_version)) = 0.4.1
Provides:       bundled(crate(rust-embed)) = 8.12.0
Provides:       bundled(crate(rust-embed-impl)) = 8.12.0
Provides:       bundled(crate(rust-embed-utils)) = 8.12.0
Provides:       bundled(crate(rustix)) = 1.1.4
Provides:       bundled(crate(rustls)) = 0.23.41
Provides:       bundled(crate(rustls-pki-types)) = 1.15.0
Provides:       bundled(crate(rustls-webpki)) = 0.103.13
Provides:       bundled(crate(rustversion)) = 1.0.23
...
Provides:       bundled(crate(sha2)) = 0.11.0
...
Provides:       bundled(crate(smallvec)) = 1.15.2
...
Provides:       bundled(crate(system-deps)) = 7.0.8
Provides:       bundled(crate(tar)) = 0.4.46
Provides:       bundled(crate(target-lexicon)) = 0.13.5
...
Provides:       bundled(crate(thread_local)) = 1.1.10
Provides:       bundled(crate(threadpool)) = 1.8.1
Provides:       bundled(crate(thread-priority)) = 3.1.1
Provides:       bundled(crate(time)) = 0.3.53
Provides:       bundled(crate(time-core)) = 0.1.9
Provides:       bundled(crate(time-macros)) = 0.2.31
...
Provides:       bundled(crate(toml_writer-1.1.1+spec)) = 1.1.0
...
Provides:       bundled(crate(tracing-subscriber)) = 0.3.23
Provides:       bundled(crate(tracker)) = 0.2.3
Provides:       bundled(crate(tracker-macros)) = 0.2.3
...
Provides:       bundled(crate(vergen)) = 10.0.1
Provides:       bundled(crate(vergen-gitcl)) = 10.0.1
Provides:       bundled(crate(vergen-lib)) = 10.0.1
...
Provides:       bundled(crate(wasip2-1.0.4+wasi)) = 0.2.12
Provides:       bundled(crate(wasm-bindgen)) = 0.2.126
Provides:       bundled(crate(wasm-bindgen-macro)) = 0.2.126
Provides:       bundled(crate(wasm-bindgen-macro-support)) = 0.2.126
Provides:       bundled(crate(wasm-bindgen-shared)) = 0.2.126
Provides:       bundled(crate(webpki-roots)) = 1.0.8
Provides:       bundled(crate(web-sys)) = 0.3.103
...
Provides:       bundled(crate(zbus)) = 5.17.0
Provides:       bundled(crate(zbus_macros)) = 5.17.0
Provides:       bundled(crate(zbus_names)) = 4.3.3
Provides:       bundled(crate(zbus_polkit)) = 5.0.0
Provides:       bundled(crate(zerocopy)) = 0.8.54
Provides:       bundled(crate(zerocopy-derive)) = 0.8.54
Provides:       bundled(crate(zerofrom)) = 0.1.8
Provides:       bundled(crate(zerofrom-derive)) = 0.1.7
Provides:       bundled(crate(zeroize)) = 1.9.0
...
Provides:       bundled(crate(zvariant)) = 5.13.0
Provides:       bundled(crate(zvariant_derive)) = 5.13.0
Provides:       bundled(crate(zvariant_utils)) = 3.5.0
%endif
...
%autosetup -p1 -n %{pkgname}-%{?with_snapshot:%{commit}}%{!?with_snapshot:%{version}} %{?with_vendor:-a1}
