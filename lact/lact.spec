...
%global vendor_hash 3849155c2d5258303695ee30c90b0999
...
Provides:       bundled(crate(arc-swap)) = 1.8.2
...
Provides:       bundled(crate(cfg-expr)) = 0.20.6
...
Provides:       bundled(crate(insta)) = 1.46.3
...
Provides:       bundled(crate(nvml-wrapper)) = 0.12.0
...
Provides:       bundled(crate(ureq)) = 3.2.0
...
Provides:       bundled(crate(webpki-roots)) = 1.0.6
...
Provides:       bundled(crate(zbus_macros)) = 5.13.2
...
Provides:       bundled(crate(zvariant)) = 5.9.2
Provides:       bundled(crate(zvariant_derive)) = 5.9.2
