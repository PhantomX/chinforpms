...
%build
%meson \
  -D package-name='chinforpms GStreamer-plugins-base package' \
...
#rm -f %{buildroot}%{_bindir}/gst-visualise*
#rm -f %{buildroot}%{_mandir}/man1/gst-visualise*
...
chrpath --delete %{buildroot}%{_libdir}/gstreamer-%{majorminor}/libgstencoding.so
chrpath --delete %{buildroot}%{_libdir}/gstreamer-%{majorminor}/libgstrawparse.so
...
chrpath --delete %{buildroot}%{_libdir}/gstreamer-%{majorminor}/libgstvideorate.so
...
chrpath --delete %{buildroot}%{_bindir}/gst-device-monitor-1.0
chrpath --delete %{buildroot}%{_bindir}/gst-discoverer-1.0
chrpath --delete %{buildroot}%{_bindir}/gst-play-1.0
%endif
