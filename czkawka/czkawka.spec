...
Source0:        %{url}/releases/download/%{version}/linux_%{name}_gui.AppImage#/%{name}-%{version}.AppImage
...
%changelog
* Sat Aug 26 2023 Phantom X <megaphantomx at hotmail dot com> - 6.0.0-1
- 6.0.0

* Sun Mar 05 2023 Phantom X <megaphantomx at hotmail dot com> - 5.1.0-1
- 5.1.0
