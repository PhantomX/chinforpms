%global gitcommitid 7620d561ac4d965eb7822b7922ed458de23ee9a6
...
%if 0%{?use_git}
Source0:        https://github.com/MeanEYE/Disk-Indicator/archive/%{gitcommitid}.tar.gz#/%{name}-%{shortcommit}.tar.gz
%else
...
%prep
%if 0%{?use_git}
%autosetup -n Disk-Indicator-%{gitcommitid} -p0
%else
