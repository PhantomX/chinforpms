...
Source1:        http://download.savannah.gnu.org/releases/lzip/%{name}-%{version}.tar.gz.sig
...
%changelog
* Fri May 31 2019 Phantom X <megaphantomx at bol dot com dot br> - 1:1.21-100
- 1.21
- Pass proper compilation flags
