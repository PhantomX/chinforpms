...
%global vendor_hash eb2de2c67bf2fa229c1aca5bada544a0
...
Provides:       bundled(crate(blake3)) = 1.8.3
...
Provides:       bundled(crate(cc)) = 1.2.54
...
Provides:       bundled(crate(find-msvc-tools)) = 0.1.8
Provides:       bundled(crate(fixedbitset)) = 0.5.7
Provides:       bundled(crate(flate2)) = 1.1.8
...
Provides:       bundled(crate(glslang-sys)) = 0.7.0+1062752
...
Provides:       bundled(crate(pest)) = 2.8.5
Provides:       bundled(crate(pest_derive)) = 2.8.5
Provides:       bundled(crate(pest_generator)) = 2.8.5
Provides:       bundled(crate(pest_meta)) = 2.8.5
...
Provides:       bundled(crate(portable-atomic)) = 1.13.0
...
Provides:       bundled(crate(spirv-cross-sys)) = 0.4.3+e670b39
...
Provides:       bundled(crate(wgpu)) = 28.0.0
Provides:       bundled(crate(wgpu-core)) = 28.0.0
Provides:       bundled(crate(wgpu-core-deps-apple)) = 28.0.0
Provides:       bundled(crate(wgpu-core-deps-emscripten)) = 28.0.0
Provides:       bundled(crate(wgpu-core-deps-windows-linux-android)) = 28.0.0
Provides:       bundled(crate(wgpu-hal)) = 28.0.0
Provides:       bundled(crate(wgpu-types)) = 28.0.0
...
Provides:       bundled(crate(zerocopy)) = 0.8.33
Provides:       bundled(crate(zerocopy-derive)) = 0.8.33
Provides:       bundled(crate(zigzag)) = 0.1.0
Provides:       bundled(crate(zmij)) = 1.0.16
Provides:       bundled(crate(zune-core)) = 0.5.1
Provides:       bundled(crate(zune-jpeg)) = 0.5.11
%endif
