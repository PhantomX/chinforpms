...
%global vendor_hash 65a5f18f5f33e302ba548a7521419d15
...
License: %{shrink:
  MPL-2.0 OR GPL-3.0-only%{?with_vendor: AND
  ...
  BSD-3-Clause AND CC0-1.0 AND (CC0-1.0 OR Apache-2.0) AND
  ...
  MPL-2.0 AND
  (Unlicense OR MIT) AND Zlib AND
  (Zlib OR Apache-2.0 OR MIT))}
}
URL:            https://github.com/SnowflakePowered/%{name}
Source0:        %{url}/archive/%{name}-v%{version}/%{name}-%{version}.tar.gz
%if %{with vendor}
# cargo vendor --versioned-dirs && tar --numeric-owner -cvJf ../%%{name}-capi-%%{version}-vendor.tar.xz vendor/
...
Provides:       bundled(crate(array-concat)) = 0.5.5
...
Provides:       bundled(crate(bit-set)) = 0.10.1
Provides:       bundled(crate(bit-set)) = 0.8.0
Provides:       bundled(crate(bit-vec)) = 0.10.0
Provides:       bundled(crate(bit-vec)) = 0.8.0
Provides:       bundled(crate(bit-vec)) = 0.9.1
Provides:       bundled(crate(bitvec)) = 1.0.1
Provides:       bundled(crate(blake3)) = 1.8.5
...
Provides:       bundled(crate(cbindgen)) = 0.29.3
...
Provides:       bundled(crate(codespan-reporting)) = 0.13.1
...
Provides:       bundled(crate(constant_time_eq)) = 0.4.2
...
Provides:       bundled(crate(crc)) = 3.4.0
Provides:       bundled(crate(crc-catalog)) = 2.5.0
...
Provides:       bundled(crate(d3d12-descriptor-heap)) = 0.2.1
Provides:       bundled(crate(data-encoding)) = 2.11.0
...
Provides:       bundled(crate(glow)) = 0.17.0
Provides:       bundled(crate(glslang)) = 0.8.1
Provides:       bundled(crate(glslang-sys)) = 0.8.1+275822a
Provides:       bundled(crate(glutin_wgl_sys)) = 0.6.1
Provides:       bundled(crate(gpu-allocator)) = 0.28.0
Provides:       bundled(crate(half)) = 2.7.1
Provides:       bundled(crate(halfbrown)) = 0.4.0
...
Provides:       bundled(crate(image-compare)) = 0.4.2
...
Provides:       bundled(crate(mach-dxcompiler-rs-0.1.4+2024.11.22)) = df583a3.1
...
Provides:       bundled(crate(objc2-metal)) = 0.3.2
Provides:       bundled(crate(objc2-metal-kit)) = 0.3.2
Provides:       bundled(crate(objc2-model-io)) = 0.3.2
...
Provides:       bundled(crate(orbclient)) = 0.3.55
...
Provides:       bundled(crate(persy)) = 1.7.1
...
Provides:       bundled(crate(quick-xml)) = 0.39.4
...
Provides:       bundled(crate(redox_syscall)) = 0.8.1
...
Provides:       bundled(crate(rmp)) = 0.8.15
Provides:       bundled(crate(rmp-serde)) = 1.3.1
Provides:       bundled(crate(ron)) = 0.7.1
Provides:       bundled(crate(rspirv-0.13.0+sdk)) = 1.4.341.0
...
Provides:       bundled(crate(spirv-0.4.0+sdk)) = 1.4.341.0
Provides:       bundled(crate(spirv-cross2)) = 0.7.1
Provides:       bundled(crate(spirv-cross2-derive)) = 0.1.0
Provides:       bundled(crate(spirv-cross-sys)) = 0.7.2+38681a3
Provides:       bundled(crate(spirv-to-dxil)) = 0.4.7
Provides:       bundled(crate(spirv-to-dxil-sys)) = 0.4.7
Provides:       bundled(crate(spq-core)) = 1.0.6
...
Provides:       bundled(crate(strumbra)) = 0.6.0
...
Provides:       bundled(crate(toml-0.9.12+spec)) = 1.1.0
...
Provides:       bundled(crate(triomphe)) = 0.1.15
...
Provides:       bundled(crate(unicode-segmentation)) = 1.13.3
...
Provides:       bundled(crate(wgpu)) = 30.0.0
Provides:       bundled(crate(wgpu-core)) = 30.0.0
Provides:       bundled(crate(wgpu-core-deps-apple)) = 30.0.0
Provides:       bundled(crate(wgpu-core-deps-emscripten)) = 30.0.0
Provides:       bundled(crate(wgpu-core-deps-windows-linux-android)) = 30.0.0
Provides:       bundled(crate(wgpu-hal)) = 30.0.0
Provides:       bundled(crate(wgpu-naga-bridge)) = 30.0.0
Provides:       bundled(crate(wgpu-types)) = 30.0.0
...
%changelog
* Sun Jul 05 2026 Phantom X <megaphantomx at hotmail dot com> - 0.12.0-1
- 0.12.0

* Fri Mar 20 2026 Phantom X <megaphantomx at hotmail dot com> - 0.10.1-1
- 0.10.1

* Tue Dec 23 2025 Phantom X <megaphantomx at hotmail dot com> - 0.9.2-1
- 0.9.2
