...
%global vendor_hash 16de77ee64d6d6dbcab53b143a9db111
...
Provides:       bundled(crate(allocator-api2)) = 0.2.20
...
Provides:       bundled(crate(anyhow)) = 1.0.93
...
Provides:       bundled(crate(bytemuck)) = 1.20.0
Provides:       bundled(crate(bytemuck_derive)) = 1.8.0
Provides:       bundled(crate(byteorder)) = 1.5.0
Provides:       bundled(crate(byteorder-lite)) = 0.1.0
Provides:       bundled(crate(bytes)) = 1.8.0
...
Provides:       bundled(crate(cc)) = 1.2.1
...
Provides:       bundled(crate(cpufeatures)) = 0.2.15
...
Provides:       bundled(crate(fastrand)) = 2.2.0
Provides:       bundled(crate(fdeflate)) = 0.3.6
...
Provides:       bundled(crate(glow)) = 0.14.2
Provides:       bundled(crate(glow)) = 0.15.0
Provides:       bundled(crate(glslang)) = 0.6.1
Provides:       bundled(crate(glslang-sys)) = 0.6.2+3454c36
...
Provides:       bundled(crate(hashbrown)) = 0.15.1
...
Provides:       bundled(crate(image)) = 0.25.5
Provides:       bundled(crate(image-compare)) = 0.4.1
Provides:       bundled(crate(image-webp)) = 0.2.0
...
Provides:       bundled(crate(naga)) = 23.0.0
...
Provides:       bundled(crate(ordered-float)) = 4.5.0
...
Provides:       bundled(crate(pathdiff)) = 0.2.2
Provides:       bundled(crate(percent-encoding)) = 2.3.1
Provides:       bundled(crate(persy)) = 1.5.2
...
Provides:       bundled(crate(proc-macro2)) = 1.0.89
...
Provides:       bundled(crate(rustix)) = 0.38.41
...
Provides:       bundled(crate(wasm-bindgen)) = 0.2.95
Provides:       bundled(crate(wasm-bindgen-backend)) = 0.2.95
Provides:       bundled(crate(wasm-bindgen-futures)) = 0.4.45
Provides:       bundled(crate(wasm-bindgen-macro)) = 0.2.95
Provides:       bundled(crate(wasm-bindgen-macro-support)) = 0.2.95
Provides:       bundled(crate(wasm-bindgen-shared)) = 0.2.95
Provides:       bundled(crate(wayland-backend)) = 0.3.7
Provides:       bundled(crate(wayland-client)) = 0.31.7
Provides:       bundled(crate(wayland-csd-frame)) = 0.3.0
Provides:       bundled(crate(wayland-cursor)) = 0.31.7
...
Provides:       bundled(crate(web-sys)) = 0.3.72
Provides:       bundled(crate(web-time)) = 0.2.4
Provides:       bundled(crate(weezl)) = 0.1.8
Provides:       bundled(crate(wgpu)) = 23.0.0
Provides:       bundled(crate(wgpu-core)) = 23.0.0
Provides:       bundled(crate(wgpu-hal)) = 23.0.0
Provides:       bundled(crate(wgpu-types)) = 23.0.0
...
Provides:       bundled(crate(xml-rs)) = 0.8.23
