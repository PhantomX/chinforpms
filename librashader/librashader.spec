...
%global vendor_hash a2731a69af3c391a34b960e52ef88619
...
Provides:       bundled(crate(cc)) = 1.2.45
...
Provides:       bundled(crate(data-encoding)) = 2.9.0
...
Provides:       bundled(crate(find-msvc-tools)) = 0.1.4
...
Provides:       bundled(crate(generic-array)) = 0.14.9
...
Provides:       bundled(crate(image)) = 0.25.8
Provides:       bundled(crate(image-compare)) = 0.4.2
Provides:       bundled(crate(indexmap)) = 2.12.0
...
Provides:       bundled(crate(moxcms)) = 0.7.9
...
Provides:       bundled(crate(orbclient)) = 0.3.49
...
Provides:       bundled(crate(pest)) = 2.8.3
Provides:       bundled(crate(pest_derive)) = 2.8.3
Provides:       bundled(crate(pest_generator)) = 2.8.3
Provides:       bundled(crate(pest_meta)) = 2.8.3
...
Provides:       bundled(crate(pxfm)) = 0.1.25
...
Provides:       bundled(crate(syn)) = 2.0.110
...
Provides:       bundled(crate(wasm-bindgen-futures)) = 0.4.55
...
Provides:       bundled(crate(zerocopy)) = 0.8.27
Provides:       bundled(crate(zerocopy-derive)) = 0.8.27
