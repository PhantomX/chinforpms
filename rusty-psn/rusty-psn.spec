...
Source0:        %{url}/releases/download/%{version}/rusty-psn-cli-linux.zip#/%{name}-cli-%{version}-linux.zip
Source1:        %{url}/releases/download/%{version}/rusty-psn-egui-linux.zip#/%{name}-egui-%{version}-linux.zip
