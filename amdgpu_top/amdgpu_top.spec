...
Provides:       bundled(crate(arc-swap)) = 1.8.1
...
Provides:       bundled(crate(calloop)) = 0.14.3
...
Provides:       bundled(crate(egui_plot)) = 0.34.0
...
Provides:       bundled(crate(gix)) = 0.78.0
Provides:       bundled(crate(gix-actor)) = 0.38.0
Provides:       bundled(crate(gix-chunk)) = 0.5.0
Provides:       bundled(crate(gix-command)) = 0.7.0
Provides:       bundled(crate(gix-commitgraph)) = 0.32.0
Provides:       bundled(crate(gix-config)) = 0.51.0
Provides:       bundled(crate(gix-config-value)) = 0.17.0
Provides:       bundled(crate(gix-date)) = 0.13.0
Provides:       bundled(crate(gix-diff)) = 0.58.0
Provides:       bundled(crate(gix-discover)) = 0.46.0
Provides:       bundled(crate(gix-error)) = 0.0.0
Provides:       bundled(crate(gix-features)) = 0.46.0
Provides:       bundled(crate(gix-fs)) = 0.19.0
Provides:       bundled(crate(gix-glob)) = 0.24.0
Provides:       bundled(crate(gix-hash)) = 0.22.0
Provides:       bundled(crate(gix-hashtable)) = 0.12.0
Provides:       bundled(crate(gix-lock)) = 21.0.0
Provides:       bundled(crate(gix-object)) = 0.55.0
Provides:       bundled(crate(gix-odb)) = 0.75.0
Provides:       bundled(crate(gix-pack)) = 0.65.0
Provides:       bundled(crate(gix-packetline)) = 0.21.0
Provides:       bundled(crate(gix-path)) = 0.11.0
Provides:       bundled(crate(gix-protocol)) = 0.56.0
Provides:       bundled(crate(gix-quote)) = 0.6.1
Provides:       bundled(crate(gix-ref)) = 0.58.0
Provides:       bundled(crate(gix-refspec)) = 0.36.0
Provides:       bundled(crate(gix-revision)) = 0.40.0
Provides:       bundled(crate(gix-revwalk)) = 0.26.0
Provides:       bundled(crate(gix-sec)) = 0.13.0
Provides:       bundled(crate(gix-shallow)) = 0.8.0
Provides:       bundled(crate(gix-tempfile)) = 21.0.0
Provides:       bundled(crate(gix-trace)) = 0.1.17
Provides:       bundled(crate(gix-transport)) = 0.53.0
Provides:       bundled(crate(gix-traverse)) = 0.52.0
Provides:       bundled(crate(gix-url)) = 0.35.0
...
Provides:       bundled(crate(jiff)) = 0.2.18
Provides:       bundled(crate(jiff-static)) = 0.2.18
Provides:       bundled(crate(jiff-tzdb)) = 0.1.5
...
Provides:       bundled(crate(js-sys)) = 0.3.85
...
Provides:       bundled(crate(memmap2)) = 0.9.9
...
Provides:       bundled(crate(redox_syscall)) = 0.7.0
...
Provides:       bundled(crate(ryu)) = 1.0.22
...
Provides:       bundled(crate(time)) = 0.3.46
Provides:       bundled(crate(time-core)) = 0.1.8
Provides:       bundled(crate(time-macros)) = 0.2.26
...
Provides:       bundled(crate(wasm-bindgen)) = 0.2.108
Provides:       bundled(crate(wasm-bindgen-futures)) = 0.4.58
Provides:       bundled(crate(wasm-bindgen-macro)) = 0.2.108
Provides:       bundled(crate(wasm-bindgen-macro-support)) = 0.2.108
Provides:       bundled(crate(wasm-bindgen-shared)) = 0.2.108
...
Provides:       bundled(crate(webbrowser)) = 1.0.6
Provides:       bundled(crate(web-sys)) = 0.3.85
...
Provides:       bundled(crate(zerocopy)) = 0.8.38
Provides:       bundled(crate(zerocopy-derive)) = 0.8.38
...
Provides:       bundled(crate(zlib-rs)) = 0.5.5
Provides:       bundled(crate(zmij)) = 1.0.19
