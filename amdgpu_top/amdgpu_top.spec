...
%global vendor_hash 62b43f71f867997f24cfa8c907e8e61d
...
Provides:       bundled(crate(accesskit)) = 0.21.1
...
Provides:       bundled(crate(android-activity)) = 0.6.1
...
Provides:       bundled(crate(arc-swap)) = 1.9.1
...
Provides:       bundled(crate(bytesize)) = 2.3.1
...
Provides:       bundled(crate(cc)) = 1.2.60
...
Provides:       bundled(crate(clru)) = 0.6.3
...
Provides:       bundled(crate(ecolor)) = 0.33.3
Provides:       bundled(crate(eframe)) = 0.33.3
Provides:       bundled(crate(egui)) = 0.33.3
Provides:       bundled(crate(egui_glow)) = 0.33.3
Provides:       bundled(crate(egui_plot)) = 0.34.1
Provides:       bundled(crate(egui-wgpu)) = 0.33.3
Provides:       bundled(crate(egui-winit)) = 0.33.3
Provides:       bundled(crate(emath)) = 0.33.3
...
Provides:       bundled(crate(epaint)) = 0.33.3
Provides:       bundled(crate(epaint_default_fonts)) = 0.33.3
...
Provides:       bundled(crate(filetime)) = 0.2.27
...
Provides:       bundled(crate(gix)) = 0.81.0
Provides:       bundled(crate(gix-actor)) = 0.40.0
Provides:       bundled(crate(gix-archive)) = 0.30.0
Provides:       bundled(crate(gix-attributes)) = 0.31.0
Provides:       bundled(crate(gix-bitmap)) = 0.3.0
Provides:       bundled(crate(gix-blame)) = 0.11.0
Provides:       bundled(crate(gix-chunk)) = 0.7.0
Provides:       bundled(crate(gix-command)) = 0.8.0
Provides:       bundled(crate(gix-commitgraph)) = 0.35.0
Provides:       bundled(crate(gix-config)) = 0.54.0
Provides:       bundled(crate(gix-config-value)) = 0.17.1
Provides:       bundled(crate(gix-credentials)) = 0.37.1
Provides:       bundled(crate(gix-date)) = 0.15.1
Provides:       bundled(crate(gix-diff)) = 0.61.0
Provides:       bundled(crate(gix-dir)) = 0.23.0
Provides:       bundled(crate(gix-discover)) = 0.49.0
Provides:       bundled(crate(gix-error)) = 0.2.1
Provides:       bundled(crate(gix-features)) = 0.46.2
Provides:       bundled(crate(gix-filter)) = 0.28.0
Provides:       bundled(crate(gix-fs)) = 0.19.2
Provides:       bundled(crate(gix-glob)) = 0.24.0
Provides:       bundled(crate(gix-hash)) = 0.23.0
Provides:       bundled(crate(gix-hashtable)) = 0.13.0
Provides:       bundled(crate(gix-ignore)) = 0.19.1
Provides:       bundled(crate(gix-index)) = 0.49.0
Provides:       bundled(crate(gix-lock)) = 21.0.2
Provides:       bundled(crate(gix-mailmap)) = 0.32.0
Provides:       bundled(crate(gix-merge)) = 0.14.0
Provides:       bundled(crate(gix-negotiate)) = 0.29.0
Provides:       bundled(crate(gix-object)) = 0.58.0
Provides:       bundled(crate(gix-odb)) = 0.78.0
Provides:       bundled(crate(gix-pack)) = 0.68.0
Provides:       bundled(crate(gix-packetline)) = 0.21.2
Provides:       bundled(crate(gix-path)) = 0.11.2
Provides:       bundled(crate(gix-pathspec)) = 0.16.1
Provides:       bundled(crate(gix-prompt)) = 0.14.1
Provides:       bundled(crate(gix-protocol)) = 0.59.0
Provides:       bundled(crate(gix-quote)) = 0.7.0
Provides:       bundled(crate(gix-ref)) = 0.61.0
Provides:       bundled(crate(gix-refspec)) = 0.39.0
Provides:       bundled(crate(gix-revision)) = 0.43.0
Provides:       bundled(crate(gix-revwalk)) = 0.29.0
Provides:       bundled(crate(gix-sec)) = 0.13.2
Provides:       bundled(crate(gix-shallow)) = 0.10.0
Provides:       bundled(crate(gix-status)) = 0.28.0
Provides:       bundled(crate(gix-submodule)) = 0.28.0
Provides:       bundled(crate(gix-tempfile)) = 21.0.2
Provides:       bundled(crate(gix-trace)) = 0.1.18
Provides:       bundled(crate(gix-transport)) = 0.55.1
Provides:       bundled(crate(gix-traverse)) = 0.55.0
Provides:       bundled(crate(gix-url)) = 0.35.2
Provides:       bundled(crate(gix-utils)) = 0.3.1
Provides:       bundled(crate(gix-validate)) = 0.11.0
Provides:       bundled(crate(gix-worktree)) = 0.50.0
Provides:       bundled(crate(gix-worktree-state)) = 0.28.0
Provides:       bundled(crate(gix-worktree-stream)) = 0.30.0
...
Provides:       bundled(crate(human_format)) = 1.2.1
...
Provides:       bundled(crate(imara-diff)) = 0.1.8
Provides:       bundled(crate(imara-diff)) = 0.2.0
...
Provides:       bundled(crate(io-close)) = 0.3.7
Provides:       bundled(crate(itoa)) = 1.0.18
Provides:       bundled(crate(jiff)) = 0.2.23
Provides:       bundled(crate(jiff-static)) = 0.2.23
Provides:       bundled(crate(jiff-tzdb)) = 0.1.6
Provides:       bundled(crate(jiff-tzdb-platform)) = 0.1.3
Provides:       bundled(crate(jni)) = 0.22.4
Provides:       bundled(crate(jni-macros)) = 0.22.4
...
Provides:       bundled(crate(nix)) = 0.31.2
Provides:       bundled(crate(nohash-hasher)) = 0.2.0
Provides:       bundled(crate(nonempty)) = 0.12.0
...
Provides:       bundled(crate(objc2)) = 0.6.4
...
Provides:       bundled(crate(orbclient)) = 0.3.53
Provides:       bundled(crate(ordered-float)) = 5.3.0
...
Provides:       bundled(crate(pin-project)) = 1.1.11
Provides:       bundled(crate(pin-project-internal)) = 1.1.11
...
Provides:       bundled(crate(redox_syscall)) = 0.7.4
...
Provides:       bundled(crate(ron)) = 0.11.0
...
Provides:       bundled(crate(shell-words)) = 1.1.1
Provides:       bundled(crate(shlex)) = 1.3.0
Provides:       bundled(crate(signal-hook)) = 0.3.18
Provides:       bundled(crate(signal-hook)) = 0.4.4
...
Provides:       bundled(crate(simd_cesu8)) = 1.1.1
...
Provides:       bundled(crate(toml_edit-0.25.11+spec)) = 1.1.0
...
Provides:       bundled(crate(typenum)) = 1.20.0
Provides:       bundled(crate(uluru)) = 3.1.0
...
Provides:       bundled(crate(unicode-normalization)) = 0.1.25
Provides:       bundled(crate(unicode-segmentation)) = 1.13.2
...
Provides:       bundled(crate(wasm-bindgen-futures)) = 0.4.68
...
Provides:       bundled(crate(wayland-backend)) = 0.3.15
Provides:       bundled(crate(wayland-client)) = 0.31.14
Provides:       bundled(crate(wayland-csd-frame)) = 0.3.0
Provides:       bundled(crate(wayland-cursor)) = 0.31.14
Provides:       bundled(crate(wayland-protocols)) = 0.32.12
Provides:       bundled(crate(wayland-protocols-experimental)) = 20250721.0.1
Provides:       bundled(crate(wayland-protocols-misc)) = 0.3.12
Provides:       bundled(crate(wayland-protocols-plasma)) = 0.3.12
Provides:       bundled(crate(wayland-protocols-wlr)) = 0.3.12
Provides:       bundled(crate(wayland-scanner)) = 0.31.10
Provides:       bundled(crate(wayland-sys)) = 0.31.11
Provides:       bundled(crate(webbrowser)) = 1.2.1
Provides:       bundled(crate(web-sys)) = 0.3.95
...
Provides:       bundled(crate(winit)) = 0.30.13
Provides:       bundled(crate(winnow)) = 0.7.15
Provides:       bundled(crate(winnow)) = 1.0.2
...
Provides:       bundled(crate(zerocopy-derive)) = 0.8.48
...
Provides:       bundled(crate(zlib-rs)) = 0.6.3
...
%changelog
* Sun Jun 07 2026 Phantom X <megaphantomx at hotmail dot com> - 0.11.5-1
- 0.11.5
