...
Patch123:       0001-CSD-server-side-shadow.patch
...
Requires: gtk4%{?_isa} = %{?epoch:%{epoch}:}%{version}-%{release}
...
* Sun Nov 19 2023 Phantom X <megaphantomx at hotmail dot com> - 1:4.12.4-100
- 4.12.4
...
* Sun Jul 03 2022 Phantom X <megaphantomx at hotmail dot com> - 1:4.6.6-100
- 4.6.6

* Tue May 31 2022 Phantom X <megaphantomx at hotmail dot com> - 1:4.6.5-100
- 4.6.5
